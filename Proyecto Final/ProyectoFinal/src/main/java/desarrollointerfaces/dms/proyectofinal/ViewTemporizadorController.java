            ...
            public void run() {
                try {
                    ...
                    while(true) {
                        ...
                        //Si los segundos llegan a 0 entonces salta un Alert
                        ...
                        alert.setHeaderText("Recordatorio del Temporizador");
                        alert.setContentText("El periodo de la tarea: " + mensaje + " ha finalizado correctamente.");
                        alert.showAndWait();
